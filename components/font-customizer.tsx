...
export function FontCustomizer({ label, config, onChange }: FontCustomizerProps) {
  return (
    <div className="space-y-4 p-4 border rounded-lg">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Slider
            ...
            onValueChange={(value) => onChange({ ...config, fontSize: value[0] })}
            min={12}
            max={120}
            step={1}
            className="w-full"
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          />
          <span className="text-sm text-gray-600 dark:text-gray-400">{config.color}</span>
        </div>
      </div>
